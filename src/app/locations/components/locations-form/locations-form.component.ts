        ...
        .pipe(
          ...
          catchError((error) => {
            ...
            this._messageService.add({
              severity: 'error',
              summary: 'Erreur',
              detail: 'Impossible de charger les données de la location.',
            });
            throw error;
          }),
  ...
  save() {
    if (this.locationForm.valid) {
      if (this.id) {
        // Update
        this._LocationsService
          .updateLocation(this.id, this.locationForm.value)
          .pipe(
            tap(() => {
              this._messageService.add({
                severity: 'success',
        ...
        // Create
        this._LocationsService
          .submitFormLocation(this.locationForm.value)
          .pipe(
            tap(() => {
              this._messageService.add({
                severity: 'success',
